...
7.精實製造的五大原則（Womack & Jones）

界定價值（Define Value):從顧客角度定義。

識別價值流程（Map Value Stream):找出增值與非增值活動。

建立流動（Create Flow):讓流程順暢，避免中斷。

導入拉式系統（Establish Pull):依需求生產，避免囤積。

追求完美（Pursue Perfection):持續改善，沒有盡頭。
